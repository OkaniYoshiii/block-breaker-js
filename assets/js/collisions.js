...
/**
 * @template T
 * @param { CollisionFunc<T> } collisionFunc
 * @param { Vector } movingObj
 * @param { object } fixedObj
 * @returns { T }
 */
export function anticipate(collisionFunc, movingObj, fixedObj) {
  movingObj.x += movingObj.dirX;
  movingObj.y += movingObj.dirY;

  const result = collisionFunc(movingObj, fixedObj);
